							...
							'<div class="plupload_filelist_footer">' +
								'<div class="plupload_file_name">' +
									'<div class="plupload_buttons">' +
										...
										'<a href="#" class="plupload_button plupload_start hide">' + _('Start Upload') + '</a>' +
									'</div>' +
				...
				uploader.bind('Init', function(up, res) {
					...
					$('#plupload_start').click(function(e) {
						if(settings.flagType == 'IN'){
							...
							$.post(GetSiteRoot() + '/saveRecive', $('#sendReciveForm').serialize(), function(response) {
							...
							$.post(GetSiteRoot() + '/saveSendOut', $('#sendOutForm').serialize(), function(response) {
								$form.find('.control-group').removeClass('error');
								$form.find('.help-block').empty();
								$form.find('.alert').remove();
